  ...
  return (
    <main className="admin-login-shell">
      <section className="admin-login-card">
        ...
        <h1>Admin Sign In</h1>
        <p>Only accounts explicitly added to the Supabase <strong>admin_users</strong> allowlist can enter.</p>
        <form onSubmit={submit} className="admin-login-form">
          ...
          <button type="submit" disabled={busy}>{busy ? 'CHECKING ACCESS…' : 'ENTER ADMIN PANEL'}</button>
        </form>
